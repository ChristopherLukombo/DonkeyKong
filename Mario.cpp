...
Mario::Mario() :
	mMovingUp(false), mMovingDown(false), mMovingLeft(false), mMovingRight(false), mJumping(false), mOnBlock(false), mOnLadder(false), mIsJumping(false), mCollideCoin(false)
{
